  ...
  return (
    ...
    >
      <div className="sidebar-header">
        <div className="sidebar-logo-menu-min" aria-hidden="true">
        ...
        >
          ...
          <img src="/app-icon.png" alt="ShelfAI Logo" />
        </div>
        {menuAberto && (
          <button
            ...
            {menuItems.map((item) => (
              <li key={item.name}>
                <Link
                  ...
                  className={`nav-link ${
                    pageName === item.name ? "active" : ""
                  }`}
                  title={item.description}
                  aria-current={pageName === item.name ? "page" : undefined}
                >
